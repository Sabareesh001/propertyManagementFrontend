            ...
            <td style="text-align: center">
              <div class="doc-links">
                ...
                @if (c.signedAgreementDocumentUrl) {
                  <a [href]="c.signedAgreementDocumentUrl" target="_blank" rel="noopener" class="doc-link" pTooltip="Signed agreement" tooltipPosition="top">
        ...
        <ng-template pTemplate="emptymessage">
          <tr>
            <td colspan="7" style="text-align: center; padding: 2rem;">
              ...
              <span style="color: var(--p-text-muted-color);">No signed cancellations awaiting verification</span>
            </td>
          </tr>
        </ng-template>
      </p-table>
...
export class SignedCancellationVerificationsComponent implements OnInit {
  ...
  load(): void {
    ...
    this.cancellationService.getPendingSigned(1, 100).subscribe({
      next: (res) => {
